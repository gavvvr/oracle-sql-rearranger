...
COPY --from=jar_builder $BUILD_DIR/target/oracle-sql-rearranger*with-dependencies.jar $BUILD_DIR/src.jar
RUN native-image -Os -m kg -jar src.jar -o native_binary_out
